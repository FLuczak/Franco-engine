...
/// \ingroup graphics
///
/// sf::Texture stores pixels that can be drawn, with a Texture
...
///     return -1;
///
/// // Assign it to a Texture
/// sf::Texture Texture;
/// Texture.setTexture(texture);
///
/// // Draw the textured Texture
/// window.draw(Texture);
/// \endcode
///
/// \code
...
///     return -1;
///
/// // Create a Texture that will display the texture
